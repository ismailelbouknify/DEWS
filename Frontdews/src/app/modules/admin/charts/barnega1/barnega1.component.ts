...
@Component({
  selector: 'app-barnega1',
  templateUrl: './barnega1.component.html',
  encapsulation: ViewEncapsulation.None,
})
export class Barnega1Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.chartService.getBarNega1().subscribe((data: any) => {
