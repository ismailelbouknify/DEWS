...
urlpatterns = [
    ...
    path('predictions/M_1_1Baseline1/', predictions_M_1_1Baseline, name='predictions_M_1_1Baseline'),
    path('predictions/M_1_1Baseline1/<str:student_id>/', single_student_prediction_M_1_1Baseline, name='single_student_prediction_M_1_1Baseline'),
    path('predictions/M_1_1Undrsampling1/', predictions_M_1_1Undrsampling, name='predictions_M_1_1Undrsampling'),
