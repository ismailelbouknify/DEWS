...
predictions_M_1_2Baseline = lambda request: make_predictions(request, "./Models/level_7/M_1_2/Baseline", "data_middle_1")
single_student_prediction_M_1_2Baseline = lambda request, student_id: single_student_prediction(request, "./Models/level_7/M_1_2/Baseline", "data_middle_1", student_id)
predictions_M_1_2Undrsampling = lambda request: make_predictions(request, "./Models/level_7/M_1_2/Undersampling", "data_middle_1")
single_student_prediction_M_1_2Undrsampling = lambda request, student_id: single_student_prediction(request, "./Models/level_7/M_1_2/Undersampling", "data_middle_1", student_id)
