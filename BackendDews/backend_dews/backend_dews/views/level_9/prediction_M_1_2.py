...
def make_predictions(request, model_path, index_name):
    ...
    response_data = [{'student_id': hit['_source']['id_eleve'],
                      'prediction': "Continuing" if prediction == 0 else "Dropout",
...
def single_student_prediction(request, model_path, index_name, student_id):
    ...
    prediction_result = "Continuing" if prediction[0] == 0 else "Dropout"
...
predictions_M_1_2Baseline3 = lambda request: make_predictions(request, "./Models/level_9/M_1_2/Baseline", "data_middle_3")
single_student_prediction_M_1_2Baseline3 = lambda request, student_id: single_student_prediction(request, "./Models/level_9/M_1_2/Baseline", "data_middle_3", student_id)
predictions_M_1_2Undrsampling3 = lambda request: make_predictions(request, "./Models/level_9/M_1_2/Undersampling", "data_middle_3")
single_student_prediction_M_1_2Undrsampling3 = lambda request, student_id: single_student_prediction(request, "./Models/level_9/M_1_2/Undersampling", "data_middle_3", student_id)
