...
predictions_M_1_1Baseline3 = lambda request: make_predictions(request, "./Models/level_9/M_1_1/Baseline", "data_middle_3")
single_student_prediction_M_1_1Baseline3 = lambda request, student_id: single_student_prediction(request, "./Models/level_9/M_1_1/Baseline", "data_middle_3", student_id)
predictions_M_1_1Undrsampling3 = lambda request: make_predictions(request, "./Models/level_9/M_1_1/Undersampling", "data_middle_3")
single_student_prediction_M_1_1Undrsampling3 = lambda request, student_id: single_student_prediction(request, "./Models/level_9/M_1_1/Undersampling", "data_middle_3", student_id)
